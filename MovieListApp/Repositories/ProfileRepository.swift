...
public class ProfileRepository: ObservableObject {
    ...
    init() {
        DispatchQueue.main.async{self.subscribe()}
    }
    ...
    func favouriteMovie(movieId: Int) {
        DispatchQueue.main.async{
            self.profile.favouriteList.append(movieId)
            self.updateProfile()
        }
    }
    ...
    func unfavouriteMovie(movieId: Int) {
        DispatchQueue.main.async{
            self.profile.favouriteList.removeAll { $0 == movieId }
            self.updateProfile()
        }
    }
